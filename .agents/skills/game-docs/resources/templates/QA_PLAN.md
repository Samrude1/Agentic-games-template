...
2. **Tier 2 (Browser Automated Verification)**: End-to-end playtesting checking 60 FPS, Canvas drawing, and Web Audio unlock.
...
| **UI Style Linter** | `style.css` vs `STYLE_GUIDE.md` | 100% compliance with button classes and `:root` tokens | `npm run lint:style` |
